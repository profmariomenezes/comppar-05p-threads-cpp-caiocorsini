...
clear &&
cp "/mnt/c/Users/caiof/Documentos disco local/aaaComputacao_faculdade/Computação paralela/Labs/Lab3 - MultiplicandoMatrizes/ex1MatrizesLinhaColuna.cpp" ~/CompParalel/ && \
g++ ~/CompParalel/ex1MatrizesLinhaColuna.cpp -o ~/CompParalel/ex1MatrizesLinhaColuna && \
~/CompParalel/ex1MatrizesLinhaColuna
*/

/*                              PARA COMPILAR E EXECUTAR (SEM OTIMIZACOES)
clear &&
cp "/mnt/c/Users/caiof/Documentos disco local/aaaComputacao_faculdade/Computação paralela/Labs/Lab3 - MultiplicandoMatrizes/ex1MatrizesLinhaColuna.cpp" ~/CompParalel/ && \
g++ ~/CompParalel/ex1MatrizesLinhaColuna.cpp -O0 -fno-tree-vectorize -fno-inline -o ~/CompParalel/ex1MatrizesLinhaColuna && \
~/CompParalel/ex1MatrizesLinhaColuna
*/